...
public class SemanticAnalyzer implements SemanticAnalyzerInterface {
	...
	private static final String TOKENS_PACKAGE_NAME = "tokens.";
	...
	private static final String OPERATIONS_TOKENS_PACAKGE = PARSER_PACKAGE + "tokens.operations.";
	...
	private void createFunctionParserMappings() {
		...
		for (String function : functionsList) {
			...
			String tokenName = PARSER_PACKAGE + "tokens.functions." + functionClass + "Token";
	...
	private void createOperationMappings() {
		...
		for (Object op : opProps.keySet()) {
			...
			String tokenName = OPERATIONS_TOKENS_PACAKGE + opName + "Token";
	...
	public ExpressionTreeNode generateExpressionTree(Stack<Token> tokens) {
		...
		Token t = tokens.peek();
		SemanticAnalyzerInterface analyzer = (SemanticAnalyzerInterface) tokenToSemAnalyzer.get(t.getClass());
		if (analyzer == null) {
